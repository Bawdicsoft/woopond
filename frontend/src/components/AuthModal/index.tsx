      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full  items-end justify-center p-4 sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform   transition-all sm:my-8">
                          ...
                          <div className="border rounded-3xl bg-[#0B1618] w-[600px] mx-auto p-5 text-center flex flex-col gap-5">
                            ...
                            <div className="flex gap-5 justify-center">
                              <button
                                ...
                                onClick={() => {setOpen(!open);setModalCheck(true);setSwitchModal("signin")}}
                              >
                                Login
                              </button>
                              <button
                                className="py-3 px-5 bg-[#B8EEEB] rounded-3xl text-2xl "
                                onClick={() => {setOpen(!open);setModalCheck(true);setSwitchModal("signup")}}
                              >
                                Signup
                              </button>
                            </div>
